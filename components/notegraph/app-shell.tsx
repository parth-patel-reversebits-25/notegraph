...
export function AppShell() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-background">
      {/* ── Header ────────────────────────────────────────── */}
      <header
        className="relative flex h-13 items-center gap-3 border-b border-border/60 px-4 shrink-0 z-30"
              ...
              <div className="text-center space-y-5 px-6 max-w-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Select a note from the sidebar, or create your first note to
                    get started.
                  </p>
                </div>
                <button
